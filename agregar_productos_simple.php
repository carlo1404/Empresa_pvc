...
echo "<h2>Agregando Productos de PVC</h2>";
...
// Paso 4: Copiar imágenes existentes como placeholders
echo "<h3>Paso 4: Copiando imágenes placeholder...</h3>";
...
foreach ($productos_finales as $producto) {
    ...
    if (!file_exists($ruta_imagen)) {
        // Copiar imagen de ejemplo si existe
        $imagen_ejemplo = "img/imagen3.jpg";
        if (file_exists($imagen_ejemplo)) {
            if (copy($imagen_ejemplo, $ruta_imagen)) {
                echo "<p style='color: green;'>✓ Imagen copiada: " . htmlspecialchars($producto['imagen']) . "</p>";
                $imagenes_copiadas++;
            } else {
                echo "<p style='color: orange;'>⚠ No se pudo copiar imagen para: " . htmlspecialchars($producto['imagen']) . "</p>";
            }
        } else {
            echo "<p style='color: orange;'>⚠ Imagen de ejemplo no encontrada</p>";
        }
    } else {
        echo "<p style='color: blue;'>✓ Imagen ya existe: " . htmlspecialchars($producto['imagen']) . "</p>";
    }
}

echo "<h3>Resultado Final:</h3>";
echo "<p>✓ Productos agregados: " . $productos_agregados . "</p>";
echo "<p>✓ Imágenes copiadas: " . $imagenes_copiadas . "</p>";
echo "<p><a href='index.php'>← Ir al inicio</a></p>";
echo "<p><a href='php/verificar_datos.php'>← Verificar datos</a></p>";
?> 